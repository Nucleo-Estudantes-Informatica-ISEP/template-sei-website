...
- No backend, database, or runtime admin UI — all content lives in
  `src/data/*.json`, hand-edited and zod-validated per edition (see
  [`docs/implementation/architecture.md`](../implementation/architecture.md)).
  An organizer who wants a CRUD-style editing experience doesn't get one;
  editing means editing JSON in a fork.
